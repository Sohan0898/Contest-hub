...
const MyProfile = () => {
  ...
  const handleUpdate = async (data) => {
    ...
    // find the user with the matching email in users
    ...
    if (matchingUser) {
      ...
      axiosSecure.patch(`/users/${matchingUser._id}`, userInfo).then((res) => {
        if (res.data.modifiedCount > 0) {
          console.log("Updated user info added to the DB");
          reset();

          toast.success(`Profile has been updated`);
          refetch();

          // colse modal after update
  ...
  return (
    <div>
      {/* my profile */}
      <div className="px-1 py-5 my-8">
        <div className="w-full max-w-xl bg-white border  rounded-lg shadow dark:bg-gray-200 ">
